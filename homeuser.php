...
<html lang="en">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="homeuser.php">Home</a>
...
<div class="col-sm-3 col-sm-offset-1 blog-sidebar">
          <div class="sidebar-module sidebar-module-inset">
            <h4>------</h4>
            <p>If you want to delete or update your curhatan, please contact admin <a href="http://www.instagram.com/gladysdw">@gladysdw</a>.</p>
          </div>
        </div>
    ...
    <div class="blog-footer">
      ...
      <p>
        <a href="homeuser.php">Back to top</a>
      </p>
    </div>
